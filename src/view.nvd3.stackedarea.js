...
my.NVD3StackedArea = Backbone.View.extend({
  template: '<div class="recline-graph"> \
      <div class="panel nvd3stackedarea" style="display: block;"> \
        <div id="nvd3stackedchart"><svg></svg></div>\
      </div> \
    </div> ',
  ...
  render: function() {
    ...
    $(this.el).html(htmls);
    this.$graph = this.el.find('.panel.nvd3stackedarea');
    return this;
  },
       ...
       nv.addGraph(function() {
         ...
         chart.xAxis
          ...
          chart.yAxis
           ...
           d3.select('#nvd3stackedchart svg')
              .datum(seriesNVD3)
